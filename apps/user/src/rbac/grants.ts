...
const grantList = [
  ...
  { role: "admin", resource: "inventory", action: "update:any", attributes: "*" },
  ...
  { role: "shop", resource: "inventory", action: "update:own", attributes: "*" },
  { role: "shop", resource: "user",      action: "read:own",   attributes: "*" },
  { role: "shop", resource: "user",      action: "update:own", attributes: "*, !password" },
  ...
  { role: "user", resource: "user",    action: "update:own", attributes: "*, !password" },
