...
import { IsString, IsNumber, IsOptional, IsEnum, IsBoolean, IsDateString, IsArray, ValidateNested, Min, Max } from 'class-validator';
...
export class CreateProductDto {
  @ApiProperty({ description: 'Product SKU (Stock Keeping Unit)', example: 'IPHONE15-128GB-RED' })
  @IsString()
  sku: string;
  ...
  @ApiProperty({ description: 'SEO-friendly URL slug', example: 'iphone-15-128gb-red' })
  @IsString()
  slug: string;
  ...
  @ApiPropertyOptional({ description: 'Compare price (original price)', example: 28990000 })
  @IsOptional()
  @IsNumber()
  @Min(0)
  @Type(() => Number)
  ...
  @ApiPropertyOptional({ description: 'Inventory policy', enum: InventoryPolicy })
  @IsOptional()
...
export class GetProductsQueryDto {
  ...
  @ApiPropertyOptional({ description: 'Filter by visibility', enum: ProductVisibility })
  @IsOptional()
  @IsEnum(ProductVisibility)
  visibility?: ProductVisibility;
...
export class CreateProductVariantDto {
  ...
  @ApiProperty({ description: 'Variant SKU', example: 'IPHONE15-128GB-RED-VARIANT' })
  @IsString()
  sku: string;
  ...
  @ApiPropertyOptional({ description: 'Variant price (overrides product price)' })
  @IsOptional()
  @IsNumber()
  @Min(0)
  @Type(() => Number)
  ...
  @ApiPropertyOptional({ description: 'Inventory quantity for this variant', default: 0 })
  @IsOptional()
  @IsNumber()
  @Min(0)
  ...
  @ApiPropertyOptional({ description: 'Variant attributes (color, size, etc.)', example: { color: 'Red', size: '128GB' } })
  @IsOptional()
