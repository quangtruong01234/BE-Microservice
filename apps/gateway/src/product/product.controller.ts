...
export class ProductController {
  ...
  @ApiResponse({ status: 200, description: 'Products with inventory retrieved successfully.' })
  async getAllProductsWithInventory(@Query(ValidationPipe) query: GetProductsQueryDto) {
  ...
  @ApiParam({ name: 'id', description: 'Product ID', type: Number })
  @ApiResponse({ status: 200, description: 'Product with inventory retrieved successfully.' })
  @ApiResponse({ status: 404, description: 'Product not found.' })
  ...
  @ApiOperation({ summary: 'Get multiple products with inventory by product IDs' })
  @ApiBody({ 
    schema: {
      type: 'object',
      properties: {
  ...
  @ApiResponse({ status: 200, description: 'Products with inventory retrieved successfully.' })
  @ApiResponse({ status: 400, description: 'Bad Request - Invalid product IDs.' })
  ...
  @ApiParam({ name: 'id', description: 'Product ID', type: Number })
  @ApiQuery({ name: 'quantity', description: 'Requested quantity', type: Number })
