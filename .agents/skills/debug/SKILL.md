---
name: debug
description: Diagnose and fix TryBuy bugs with a reproducible evidence-first workflow. Use for crashes, failing endpoints, TCP/RabbitMQ issues, auth failures, database errors, or performance regressions.
---
